      ...
      <main className="relative overflow-x-hidden">
        ...
        >
          ...
          <div className="relative mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:py-24">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-600">
              Warm routines, clear communication, and joyful play — the same family-first experience you see
        ...
        <div className="mx-auto max-w-6xl px-4 pb-16 pt-8 sm:px-6 sm:pb-20 sm:pt-10">
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-violet-100 bg-white p-5 shadow-sm shadow-violet-500/5">
              <p className="text-sm font-medium text-violet-700">Program options</p>
              <p className="mt-1 text-2xl font-bold text-slate-900">{PROGRAMS.length}+</p>
            </div>
            <div className="rounded-2xl border border-violet-100 bg-white p-5 shadow-sm shadow-violet-500/5">
              <p className="text-sm font-medium text-violet-700">Built for families</p>
              <p className="mt-1 text-2xl font-bold text-slate-900">Bookings &amp; chat</p>
            </div>
            <div className="rounded-2xl border border-violet-100 bg-white p-5 shadow-sm shadow-violet-500/5">
              <p className="text-sm font-medium text-violet-700">Where we are</p>
              ...
              {PROGRAMS.map((p) => (
                <li key={p.slug}>
                  <Link
                    ...
                    className="group flex h-full flex-col overflow-hidden rounded-2xl border border-violet-100/80 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md hover:shadow-violet-500/10"
                  >
          ...
          >
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Hear from families</h2>
