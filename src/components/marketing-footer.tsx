        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:flex-wrap sm:gap-x-10">
            <div className="flex flex-col gap-2 text-sm font-medium">
              ...
              <Link href="/programs" className="text-slate-600 transition hover:text-slate-900">
                Programs
              </Link>
              <Link href="/feedback" className="text-slate-600 transition hover:text-slate-900">
                Parent feedback
              </Link>
