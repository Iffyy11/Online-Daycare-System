...
export default function RegisterPage() {
  ...
  const inputClass =
    "mt-1 w-full rounded-xl border border-violet-100 bg-white px-3 py-2.5 text-sm outline-none focus:border-violet-300 focus:ring-2 focus:ring-violet-100";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[var(--brand-mist)]/40 via-white to-[var(--brand-surface)] text-slate-900">
      ...
      <div className="mx-auto max-w-md px-4 py-8 sm:px-6 sm:py-12">
        ...
        <form
          onSubmit={submit}
          className="mt-6 space-y-4 rounded-2xl border border-violet-100 bg-white p-5 shadow-[0_24px_60px_-30px_rgba(109,40,217,0.2)] sm:mt-8 sm:p-6"
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-full bg-[#6d28d9] py-3 text-sm font-semibold text-white shadow-md shadow-violet-500/25 transition hover:bg-[#5b21b6] disabled:opacity-60"
          >
